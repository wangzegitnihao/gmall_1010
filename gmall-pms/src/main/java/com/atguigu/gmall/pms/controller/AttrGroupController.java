...
public class AttrGroupController {
    ...
    public ResponseVo<List<GroupVo>> queryGropuWithAttrsByCid(@PathVariable("catId")Long catId){
       List<GroupVo> groupVos = this.attrGroupService.queryGropuWithAttrsByCid(catId);
